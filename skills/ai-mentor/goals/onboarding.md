...
| Team maintains shared onboarding workflows and conventions | Plugins | Install the team's plugin to get their accumulated knowledge immediately |
...
### 5. Plugins — Install team-specific onboarding workflows
**Level:** Intermediate | **Tools:** Claude Code
