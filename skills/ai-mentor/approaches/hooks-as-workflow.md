...
| Tool | Support | Notes |
|------|---------|-------|
| Claude Code | Native | PreToolUse, PostToolUse, Stop, SessionStart, Notification, and 30 event types |
| OpenCode | Partial | Plugin-based hooks, less granular event types |
| Cursor | Partial | Hooks system via .cursor/hooks.json |
