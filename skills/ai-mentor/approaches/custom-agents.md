...
| Tool | Support | Notes |
|------|---------|-------|
| Claude Code | Native | `.claude/agents/` directory, frontmatter for model/tools, Agent Teams, Agent View |
| OpenCode | Partial | `opencode agent create` with granular permission scoping |
| Cursor | Partial | Custom agent definitions at .cursor/agents/ since 2026 |
| aider | None | No custom agent support |
