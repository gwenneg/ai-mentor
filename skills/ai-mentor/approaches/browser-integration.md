...
| Tool | Support | Notes |
|------|---------|-------|
| Claude Code | Native | Chrome extension for web automation, Computer Use for screen-level control |
| OpenCode | None | No browser integration |
| Cursor | Native | Agent-controlled Chromium browser via Chrome DevTools Protocol since Cursor 2.0 |
| aider | None | No browser integration |
