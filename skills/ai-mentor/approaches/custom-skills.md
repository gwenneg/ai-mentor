...
| Tool | Support | Notes |
|------|---------|-------|
| Claude Code | Native | `.claude/skills/` directory, `$ARGUMENTS`, bundled scripts, `context: fork` |
| OpenCode | Similar | Custom commands with positional arguments ($1, $2, $3) and $ARGUMENTS |
| Cursor | Native | SKILL.md-based Agent Skills and .cursor/commands/ custom slash commands |
| aider | None | No skill system |
