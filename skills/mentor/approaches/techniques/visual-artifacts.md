...
- **Design iteration on mockups**: For greenfield UI work, generate two or three visual directions as separate artifacts and A/B them with stakeholders before writing any application code. The `/design` skill (research preview, v2.1.233+, Pro/Max/Team/Enterprise) is a dedicated command for this: give it a brief and Claude publishes a canvas of editable artboards built on artifacts — pick one, tweak it, then have Claude implement it.
