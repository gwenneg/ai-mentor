...
*Last synced: 2026-08-17 · Source: [`anthropics/claude-plugins-official`](https://github.com/anthropics/claude-plugins-official) marketplace manifest*
...
| Plugin | What it does | Author | Relevant goal | Verdict |
|--------|-------------|--------|--------------|---------|
| `aiven` | Deploy managed PostgreSQL, Kafka, OpenSearch, ClickHouse, and other databases/streaming apps | Aiven | `devops` | ☑️ desk-checked 2026-08-17 — added via catalog sync, not yet exercised; free tier available |
...
| `google-cloud-storage` | Official GCS plugin: manage buckets/objects, transfer data, and configure MCP, FUSE, IAM, and lifecycle rules | Google LLC | `devops` | ☑️ desk-checked 2026-08-17 — added via catalog sync, not yet exercised; needs a Google Cloud project |
...
| `mongodb-atlas` | Connect to MongoDB Atlas clusters through the Atlas Managed MCP Server; manage clusters, projects, and network access | MongoDB | `devops` | ☑️ desk-checked 2026-08-17 — added via catalog sync, not yet exercised; needs an Atlas account (use `mongodb` instead for self-managed deployments) |
...
| `superdesign` | Design or redesign frontend UI and marketing graphics on an infinite canvas that reads your codebase for context | Superdesign dev, Inc. | `greenfield` | ☑️ desk-checked 2026-08-17 — added via catalog sync, not yet exercised |
...
| `airwallex-dev` | Build Airwallex payment integrations: checkout, card elements, KYC onboarding, and subscription billing | Airwallex | `greenfield` | ☑️ desk-checked 2026-08-17 — added via catalog sync, not yet exercised; needs an Airwallex account |
...
| `salesforce-development` | Build Salesforce apps and agents: metadata, Apex, deploy/retrieve, security, and reporting | Salesforce | `greenfield` | ☑️ desk-checked 2026-08-17 — added via catalog sync, not yet exercised; needs a Salesforce account |
...
| `streaming-skills-plugin` | Skills for streaming app development: Kafka and Flink client libraries and Schema Registry | Confluent | `devops` | ☑️ desk-checked 2026-08-17 — added via catalog sync, not yet exercised |
...
| `synthflow` | Connects Claude Code to the Synthflow AI voice-agent platform for reviewing calls and auditing agent prompts | Synthflow | `building-agents` | ☑️ desk-checked 2026-08-17 — added via catalog sync, not yet exercised; needs a Synthflow account |
...
| `noibu` | Connects Claude to ecommerce session, error, and conversion data via Noibu to surface revenue-impacting issues | Noibu | `incident-response` | ☑️ desk-checked 2026-08-17 — added via catalog sync, not yet exercised; needs a Noibu account |
...
| `atlassian-twg-cli` | Teamwork Graph CLI: agent-first interface to Jira, Confluence, Bitbucket PRs, and connected data sources | Atlassian | `documentation` | ☑️ desk-checked 2026-08-17 — added via catalog sync, not yet exercised; needs Atlassian account, run `/twg-setup` after install |
...
| `crowdstrike-falcon-fusion` | Author, deploy, and execute CrowdStrike Falcon Fusion workflows with schema validation and execution monitoring | CrowdStrike | `security` | ☑️ desk-checked 2026-08-17 — added via catalog sync, not yet exercised; needs CrowdStrike Falcon Fusion access |
