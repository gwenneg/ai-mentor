...
*Last synced: 2026-08-24 · Source: [`anthropics/claude-plugins-official`](https://github.com/anthropics/claude-plugins-official) marketplace manifest*
...
| Plugin | What it does | Author | Relevant goal | Verdict |
|--------|-------------|--------|--------------|---------|
| `aiven` | Deploy and manage Aiven's managed PostgreSQL, Kafka, OpenSearch, ClickHouse, and other data/streaming services | Aiven | `devops` | ☑️ desk-checked 2026-08-24 — added via catalog sync, not yet exercised; needs an Aiven account |
...
| `google-cloud-storage` | Official Google Cloud Storage plugin: buckets, objects, transfer, MCP, FUSE, IAM, lifecycle rules, signed URLs, Terraform | Google LLC | `devops` | ☑️ desk-checked 2026-08-24 — added via catalog sync, not yet exercised; needs a Google Cloud account |
...
| `mongodb-atlas` | MongoDB Atlas Managed MCP Server: explore data, manage collections, optimize queries, manage clusters and projects | MongoDB | `devops` | ☑️ desk-checked 2026-08-24 — added via catalog sync, not yet exercised; needs a MongoDB Atlas account |
...
| `superdesign` | Design and redesign frontend UI and marketing graphics on the Superdesign infinite canvas | Superdesign dev, Inc. | `greenfield` | ☑️ desk-checked 2026-08-24 — added via catalog sync, not yet exercised |
...
| `airwallex-dev` | Generates Airwallex payment integration code: checkout, card elements, onboarding, and subscription billing | Airwallex | `greenfield` | ☑️ desk-checked 2026-08-24 — added via catalog sync, not yet exercised; needs an Airwallex account |
...
| `salesforce-development` | Build Salesforce apps and agents: metadata, Apex, deploy/retrieve, security, reporting, capability discovery | Salesforce | `greenfield` | ☑️ desk-checked 2026-08-24 — added via catalog sync, not yet exercised; needs a Salesforce account |
...
| `streaming-skills-plugin` | Kafka and Flink client library and Schema Registry skills for streaming application developers | Confluent | `devops` | ☑️ desk-checked 2026-08-24 — added via catalog sync, not yet exercised |
...
| `synthflow` | Connects Claude to the Synthflow AI voice-agent platform: call review, prompt auditing, docs search | Synthflow | `building-agents` | ☑️ desk-checked 2026-08-24 — added via catalog sync, not yet exercised; needs a Synthflow account |
...
| `noibu` | Connects Claude to Noibu's ecommerce session, error, and conversion data plus marketing/support/commerce platforms | Noibu | `incident-response` | ☑️ desk-checked 2026-08-24 — added via catalog sync, not yet exercised; needs a Noibu account |
...
| `atlassian-twg-cli` | Atlassian Teamwork Graph CLI: agent-first access to Jira, Confluence, Bitbucket, and connected data sources | Atlassian | `documentation` | ☑️ desk-checked 2026-08-24 — added via catalog sync, not yet exercised; needs Atlassian Teamwork Graph access |
...
| `crowdstrike-falcon-fusion` | Author, deploy, and execute CrowdStrike Falcon Fusion workflows with YAML authoring and schema validation | CrowdStrike | `security` | ☑️ desk-checked 2026-08-24 — added via catalog sync, not yet exercised; needs CrowdStrike Falcon Fusion access |
