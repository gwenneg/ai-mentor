...
|---|----------|-----------|-------------|
| 1 | [Plan Mode](../solutions/plan-mode.md) | Unsure what the agent should even do | An agent is a policy wrapped around a model — explicit designs fail predictably, emergent ones fail creatively |
...
| 6 | [agent-sdk](../solutions/agent-sdk.md) | The agent is a product, not a Claude Code workflow | Programmatic sessions and custom tool definitions are a different altitude than .claude/agents/ files — the SDK is the supported path for standalone agents |
