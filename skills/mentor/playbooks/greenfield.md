...
| 5 | [feature-dev](../solutions/feature-dev.md) | A feature deserves a guided explore-design-review pipeline | Phased delivery packages the plan-build-review discipline so nobody has to remember to apply it |
| 6 | [frontend-design](../solutions/frontend-design.md) | UI work should come out production-grade by default | Auto-invoked design guidance turns the default output from 'works' into 'shippable' with zero prompting effort |
