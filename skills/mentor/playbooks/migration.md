...
| 5 | [code-modernization](../approaches/tools/code-modernization.md) | A legacy codebase needs a structured migration, not one-shot edits | Preflight analysis before transformation keeps a monolith migration from becoming a pile of broken edits |
