...
| 4 | [commit-commands](../approaches/records/commit-commands.md) | A team wants shared commit conventions as slash commands | Conventions encoded as commands are followed by default; conventions in a wiki are followed by the diligent |
