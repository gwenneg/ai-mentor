...
| 5 | [security-guidance](../approaches/security-guidance.md) | Security review should happen on every edit, automatically | A hook that reviews as code is written catches issues at the cheapest moment — before they exist in a diff |
