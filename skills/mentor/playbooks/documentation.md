...
| 6 | [claude-md-management](../approaches/records/claude-md-management.md) | A CLAUDE.md exists but nobody knows if it is still good | A scored audit against the real codebase turns 'our CLAUDE.md is probably stale' into a fix list |
| 7 | [project-artifact](../approaches/records/project-artifact.md) | Project status should live on a shareable page | A living status page with honest unverified-state markings replaces the weekly re-explanation meeting |
