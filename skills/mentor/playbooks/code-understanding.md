...
| 7 | [context7](../approaches/records/context7.md) | Working against a library version your training data predates | Version-pinned docs on demand beat guessing from stale memory — evaluation returned real Express v5 docs |
