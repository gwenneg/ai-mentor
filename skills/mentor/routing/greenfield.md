...
| 4 | [Custom Skills](../approaches/custom-skills.md) | Advanced | Your team scaffolds the same structure for every new module | The first 20% of every module is patterned boilerplate — skills encode it once and skip to the interesting work |
