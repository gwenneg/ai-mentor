...
| 4 | [Custom Skills](../approaches/custom-skills.md) | Beginner | Local dev setup takes a half-day of manual steps | A skill is executable documentation — when a step breaks you fix the skill and every future onboarder benefits |
