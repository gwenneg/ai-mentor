...
| 4 | [Custom Agents](../approaches/custom-agents.md) | Advanced | Recurring patterns specific to your project | The most impactful debt is patterns your team decided to leave; custom agents enforce those decisions and track progress |
| 5 | [Background Agents](../approaches/background-agents.md) | Intermediate | Audit takes an hour but your attention shouldn't | Audits are attention-light but time-heavy — backgrounding turns them from a thing you do into a thing you review |
