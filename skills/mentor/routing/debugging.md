...
| 4 | [Hooks](../approaches/hooks-as-workflow.md) | Intermediate | A failing test should run after every single edit | Each edit is an experiment and the test result its observation; hooks remove the delay between them |
